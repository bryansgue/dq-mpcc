...
static const casadi_int casadi_s5[8] = {20, 1, 0, 4, 5, 6, 7, 8};
...
/* quadrotor_constr_h_fun_jac_uxt_zt:(i0[15],i1[5],i2[0],i3[18])->(o0,o1[20x1,4nz],o2[1x0]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  casadi_int i;
  casadi_real **res1=res+3, *rr, *ss;
  const casadi_real **arg1=arg+4;
  casadi_real w0, w1, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11, w12, w13, w14, *w15=w+23, *w16=w+38, *w17=w+46, *w18=w+50, *w20=w+54;
  /* #0: @0 = input[0][0] */
  w0 = arg[0] ? arg[0][0] : 0;
  /* #1: @1 = input[0][1] */
  w1 = arg[0] ? arg[0][1] : 0;
  ...
  *rr++ = w14;
  ...
  /* #18: @0 = ||@17||_F */
  w0 = sqrt(casadi_dot(4, w17, w17));
  /* #19: output[0][0] = @0 */
  if (res[0]) res[0][0] = w0;
  /* #20: @18 = zeros(20x1,4nz) */
  casadi_clear(w18, 4);
  /* #21: @15 = zeros(15x1) */
  casadi_clear(w15, 15);
  /* #22: @19 = zeros(4x1,0nz) */
  /* #23: @17 = (@17/@0) */
  for (i=0, rr=w17; i<4; ++i) (*rr++) /= w0;
  /* #24: @20 = adj1_f_quat(@16, @19, @17) */
  arg1[0]=w16;
  arg1[1]=0;
  arg1[2]=w17;
  res1[0]=w20;
  ...
  /* #25: (@15[:4] += @20) */
  for (rr=w15+0, ss=w20; rr!=w15+4; rr+=1) *rr += *ss++;
  /* #26: {@0, @1, @2, @3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL} = vertsplit(@15) */
  w0 = w15[0];
  w1 = w15[1];
  w2 = w15[2];
  w3 = w15[3];
  /* #27: (@18[0] = @0) */
  for (rr=w18+0, ss=(&w0); rr!=w18+1; rr+=1) *rr = *ss++;
  /* #28: (@18[1] = @1) */
  for (rr=w18+1, ss=(&w1); rr!=w18+2; rr+=1) *rr = *ss++;
  /* #29: (@18[2] = @2) */
  for (rr=w18+2, ss=(&w2); rr!=w18+3; rr+=1) *rr = *ss++;
  /* #30: (@18[3] = @3) */
  for (rr=w18+3, ss=(&w3); rr!=w18+4; rr+=1) *rr = *ss++;
  /* #31: output[1][0] = @18 */
