...
/* quadrotor_expl_ode_fun:(i0[15],i1[5],i2[18])->(o0[15]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  casadi_int i, j, k;
  casadi_real **res1=res+1, *rr, *ss, *tt;
  const casadi_real **arg1=arg+3, *cs;
  casadi_real w0, *w1=w+74, w2, w3, w4, w5, w6, w7, w8, *w9=w+89, *w10=w+93, *w11=w+97, *w12=w+101, *w13=w+105, *w14=w+121, *w15=w+137, *w16=w+169, w17, w18, w19, w20, *w21=w+205, *w22=w+221, *w23=w+253, *w24=w+317, w25, w26, w27, w28, w29, *w30=w+386, *w31=w+394, *w32=w+409, *w33=w+412, *w34=w+415, *w35=w+418, *w36=w+427, *w37=w+430;
  /* #0: @0 = 0.5 */
  ...
  *rr++ = w29;
  ...
  /* #60: @0 = input[0][14] */
  w0 = arg[0] ? arg[0][14] : 0;
  /* #61: @31 = vertcat(@2, @3, @5, @7, @4, @6, @17, @19, @18, @20, @25, @27, @28, @29, @0) */
  rr=w31;
  *rr++ = w2;
  *rr++ = w3;
  *rr++ = w5;
  ...
  *rr++ = w0;
  ...
  /* #78: @34 = mac(@35,@36,@34) */
  for (i=0, rr=w34; i<1; ++i) for (j=0; j<3; ++j, ++rr) for (k=0, ss=w35+j, tt=w36+i*3; k<3; ++k) *rr += ss[k*3]**tt++;
  /* #79: @2 = @34[2] */
  ...
  w3 -= w7;
  /* #84: @7 = @34[0] */
  for (rr=(&w7), ss=w34+0; ss!=w34+1; ss+=1) *rr++ = *ss;
  /* #85: @4 = (@25*@7) */
  w4  = (w25*w7);
  /* #86: @2 = (@18*@2) */
  w2  = (w18*w2);
  ...
  *rr++ = w2;
  /* #101: @36 = @37[1:4] */
  for (rr=w36, ss=w37+1; ss!=w37+4; ss+=1) *rr++ = *ss;
  /* #102: @33 = mac(@34,@36,@33) */
